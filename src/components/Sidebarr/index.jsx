                        ...
                        <Sidebar className='w-full' aria-label="Sidebar with multi-level dropdown example">
                            <Sidebar.Items>
                                <Sidebar.ItemGroup>
                                    ...
                                    <Sidebar.Collapse className="hover:cursor-not-allowed" icon={Folder} label="Dossier">
                                        <Sidebar.Item>Base</Sidebar.Item>
                                    </Sidebar.Collapse>
                                    <Sidebar.Collapse className="hover:cursor-not-allowed" icon={Note} label="project">
                                        <Sidebar.Item>Base</Sidebar.Item>
                                    </Sidebar.Collapse>
                                    <Sidebar.Collapse className="hover:cursor-not-allowed" icon={Display} label="Direction technique">
                                        <Sidebar.Item>Base</Sidebar.Item>
                                    </Sidebar.Collapse>
                                    <Sidebar.Collapse className="hover:cursor-not-allowed" icon={Shield} label="Protection">
                                        <Sidebar.Item>Base</Sidebar.Item>
                                    </Sidebar.Collapse>
                                </Sidebar.ItemGroup>
                            </Sidebar.Items>
